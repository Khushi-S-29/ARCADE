...
class Config:
    ...
    def __init__(self):
        ...
        sound_move = r"C:\Users\ADMIN\OneDrive\Documents\GAMES\CHESS\assets\sounds\move.wav"
        capture_move = r"C:\Users\ADMIN\OneDrive\Documents\GAMES\CHESS\assets\sounds\capture.wav"
        self.move_sound = Sound(
            os.path.join(sound_move))
        self.capture_sound = Sound(
            os.path.join(capture_move))
