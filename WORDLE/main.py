...
class Wordle:
    ...
    def __init__(self):
        ...
        self.root.wm_iconbitmap(r'C:\Users\ADMIN\OneDrive\Documents\GAMES\WORDLE\images\icon.ico')
        ...
        self.word_api = None
        self.get_from_db()
        settings_img = r'C:\Users\ADMIN\OneDrive\Documents\GAMES\WORDLE\images\setting.png'
        self.setting = Image.open(settings_img)
        self.setting = self.setting.resize((40, 40), Image.Resampling.LANCZOS)
        self.setting = ImageTk.PhotoImage(self.setting)
        settings_img_dark = r'C:\Users\ADMIN\OneDrive\Documents\GAMES\WORDLE\images\setting_dark.png'
        self.setting_dark = Image.open(settings_img_dark)
        ...
        head_img_path = r'C:\Users\ADMIN\OneDrive\Documents\GAMES\WORDLE\images\HEAD.png'
        label = Image.open(head_img_path)
        ...
        self.status_bar = tk.Label(self.root, text=f"Score : {self.score}",font="cambria 10 bold",
                                   anchor="w",padx=10,background="#502F4C",fg="white")
    ...
    def show_buttons(self):
        ...
        for i in range(6):
            ...
            for j in range(self.word_size):
                b = tk.Button(self.button_frames[i], text="", fg="#502F4C", bd=2,
    ...
    def show_popup(self):
        ...
        popup.wm_iconbitmap(r'C:\Users\ADMIN\OneDrive\Documents\GAMES\WORDLE\images\icon.ico')
        popup.focus_force()
    ...
    def get_from_db(self):
      db_path = r"C:\Users\ADMIN\OneDrive\Documents\GAMES\WORDLE\settings.db"

      if not os.path.exists(db_path):
        # Create a new database and table if it doesn't exist
        connection = sqlite3.connect(db_path)
        cursor = connection.cursor()
        cursor.execute("CREATE TABLE IF NOT EXISTS info (id INTEGER, word_length INTEGER, high_score INTEGER)")
        cursor.execute('INSERT INTO info VALUES(?, ?, ?)', (0, 5, 0))  # Insert default values
        
        self.word_api = words_api.Words(self.word_size)  # Assuming word_size is a valid property
